...
exports.NaanControllerWeb = function() {
    ...
    {                                                                       // don't load state or can't load state
        ...
        if (!loading) {
            ...
            localStorage.setItem("nide-loading", "0.9.20+1".concat("|", msg));
        }
        naanlib.banner();
        var hostpath = naanlib.js.r("path").dirname(window.location.href);
        naanlib.start({
            cmd: 'App.version = "0.9.20+1";;\r\n'
                + 'App.cache = "66f07b15414b8643aaf8acc02124bdb5";;\r\n'
